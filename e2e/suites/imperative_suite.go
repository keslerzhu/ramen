...
func (s *ImperativeSuite) SetContext(ctx *util.TestContext) {
	ctx.Log.Info("enter SetContext")
	s.ctx = ctx
}

func (s *ImperativeSuite) SetupSuite() error {
...
func (s *ImperativeSuite) TeardownSuite() error {
	s.ctx.Log.Info("enter TeardownSuite")
	return nil
}

func (s *ImperativeSuite) Tests() []Test {
...
func (s *ImperativeSuite) TestWorkloadDeployment() error {
	s.ctx.Log.Info("enter TestWorkloadDeployment")
	s.d.Deploy(s.w)
	return nil
}

func (s *ImperativeSuite) TestEnableProtection() error {
	s.ctx.Log.Info("enter TestEnableProtection")
	s.r.EnableProtection(s.w, s.d)
	return nil
}

func (s *ImperativeSuite) TestWorkloadFailover() error {
	s.ctx.Log.Info("enter TestWorkloadFailover")
	s.r.Failover(s.w, s.d)
	return nil
}

func (s *ImperativeSuite) TestWorkloadRelocation() error {
	s.ctx.Log.Info("enter TestWorkloadRelocation")
	s.r.Relocate(s.w, s.d)
	return nil
}

func (s *ImperativeSuite) TestDisableProtection() error {
	s.ctx.Log.Info("enter TestDisableProtection")
	return nil
}

func (s *ImperativeSuite) TestWorkloadUndeployment() error {
